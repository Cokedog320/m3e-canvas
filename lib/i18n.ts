...
export const UI = {
  ...
  autoWidth: { ja: "文字の幅", en: "Text width", zh: "文本宽度" },
  ...
  listSwitch: { ja: "末尾にスイッチ", en: "Trailing switch", zh: "后置开关" },
  on: { ja: "オン", en: "On", zh: "开" },
  ...
  bothModes: { ja: "両対応", en: "Both", zh: "支持深浅色模式" },
  ...
  motionExpressive: { ja: "エクスプレッシブ", en: "Expressive", zh: "弹性动效" },
  motionHint: {
    ...
    zh: "弹性动效带有弹簧回弹效果，会应用于预览转场和生成的提示词。",
  },
  ...
  placement: { ja: "本文の縦の配置", en: "Where the body goes", zh: "元素纵向布局" },
